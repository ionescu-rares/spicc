<script>
  ...
  import billionSrc from "$lib/images/actiuni/billion.jpg";
...
<PageLayout withSpacing>
  ...
  <div class="grid-container w-full place-items-center gap-8">
    ...
    <Card thumbnail={eliminareaViolenteiSrc}
      ...
      flashmobului pe care l-am organizat în Piața Operei, la ora 13.30.</Card
    >
    <Card thumbnail={sigurantaSrc}
      ...
      2023, între orele 15 și 17, în Piața Sf. Gheorghe.</Card
    >
    ...
    <Card thumbnail={seminarSrc}
      ...
      European de Securitate Urbana/EFUS, organizat la Viena.</Card
    >
    ...
    <Card thumbnail={billionSrc}
      ...
      protest împotriva oricăror forme de violență asupra femeilor.</Card
    >
  </div>
</PageLayout>
